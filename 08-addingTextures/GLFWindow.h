  ...
  virtual void key(int key, int mods) {
    ...
    switch (key) {
      ...
      case 'C':
        ...
        std::cout << "- frame x:" << glm::to_string(fc.frame.vx) << std::endl;
        std::cout << "- frame y:" << glm::to_string(fc.frame.vy) << std::endl;
        std::cout << "- frame z:" << glm::to_string(fc.frame.vz) << std::endl;
        break;
      case 'x':
      case 'X':
